...
const urlsToCache = [
    '/rowing-weighing_2/rowing_weighing3_1.html',
    '/rowing-weighing_2/index.html',
    '/rowing-weighing_2/generate_qr2.html',
    '/rowing-weighing_2/manifest.json',
    '/rowing-weighing_2/ROW.png'
]
        ...
        caches.match(event.request).then(cachedResponse => {
            ...
            return fetch(event.request).then(response => {
                ...
                if (event.request.mode === 'navigate') {
                    return caches.match('/rowing-weighing_2/rowing_weighing3_1.html')
                }
            })
        })
    )
